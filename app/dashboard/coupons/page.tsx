    ...
    <>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400">Manage your daily and referral coupons</p>
        </motion.div>
            ...
            >
              ...
              <div className="space-y-2 text-sm text-blue-400/80">
                <div className="flex items-center justify-between">
                  ...
                  <span>1 coupon (after 15-min training)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>7:00 PM GMT</span>
                  <span>2 coupons (direct confirmation)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>3:00 PM GMT</span>
                  <span>Referral coupons (if available)</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        {activeTab === "referral" && (
          <div className="space-y-6">
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl"
            >
              <h2 className="text-xl font-semibold text-white mb-4">Referral Coupons</h2>
              <div className="space-y-3">
            ...
            >
              <h3 className="text-lg font-semibold text-cyan-300 mb-3">💎 Referral Coupon Tiers</h3>
              <div className="space-y-2 text-sm text-cyan-400/80">
                <div className="flex items-center justify-between">
                  <span>$550 - $1,250</span>
                  <span>6 coupons (3/day for 2 days)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>$3,000 - $10,000</span>
                  <span>15 coupons (3/day for 5 days)</span>
                </div>
                <p className="text-xs text-cyan-500/60 mt-3">
                  Coupons are issued at 3 PM GMT and can be accumulated over time.
                </p>
              </div>
            </motion.div>
          </div>
